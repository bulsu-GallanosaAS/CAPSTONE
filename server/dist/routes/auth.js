...
router.put('/profile', [
    ...
    (0, express_validator_1.body)('first_name').optional().isLength({ min: 2 }),
    (0, express_validator_1.body)('last_name').optional().isLength({ min: 2 }),
    (0, express_validator_1.body)('phone').optional().isMobilePhone('any'),
    (0, express_validator_1.body)('city').optional().isLength({ min: 2 }),
    (0, express_validator_1.body)('country').optional().isLength({ min: 2 })
], async (req, res) => {
    try {
        const errors = (0, express_validator_1.validationResult)(req);
        if (!errors.isEmpty()) {
        ...
        await (0, database_1.executeQuery)(`UPDATE admins SET 
